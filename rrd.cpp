...
int vm_rrd_create_rrddrop(const char *filename) {
    ...
    cmdCreate << "RRA:MIN:0.5:1:370 ";
    cmdCreate << "RRA:MAX:0.5:1:370 ";
    cmdCreate << "RRA:AVERAGE:0.5:1:370 ";
    cmdCreate << "RRA:MIN:0.5:24:370 ";
    cmdCreate << "RRA:MAX:0.5:24:370 ";
    cmdCreate << "RRA:AVERAGE:0.5:24:370 ";
    cmdCreate << "RRA:MIN:0.5:168:370 ";
    cmdCreate << "RRA:MAX:0.5:168:370 ";
    cmdCreate << "RRA:AVERAGE:0.5:168:370 ";
    cmdCreate << "RRA:MIN:0.5:8760:370 ";
    cmdCreate << "RRA:MAX:0.5:8760:370 ";
    cmdCreate << "RRA:AVERAGE:0.5:8760:370";
